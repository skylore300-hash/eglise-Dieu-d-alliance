        ...
        <aside :class="mobileMenuOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <nav class="flex-1 px-4 py-4 overflow-y-auto font-medium">
                <ul class="space-y-1.5">
                    ...
                    <li>
                        <a href="#"
                            class="group flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all duration-200 {{ request()->is('*create') ? 'bg-indigo-600 text-white shadow-md shadow-indigo-100' : 'text-gray-600 hover:bg-indigo-50 hover:text-indigo-600' }}">
                            <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                            </svg>
                            <span class="text-sm">Ajouter un membre</span>
                        </a>
                    </li>
                </ul>
            </nav>
